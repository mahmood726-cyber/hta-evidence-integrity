...
ma4_results <- read.csv(file.path(PAIRWISE70_ROOT, "analysis/ma4_results_pairwise70.csv"),
                        stringsAsFactors = FALSE)

cat("Total meta-analyses:", nrow(ma4_results), "\n\n")

# Load raw Pairwise70 data for detailed analysis
data_dir <- file.path(PAIRWISE70_ROOT, "data")
...
out_dir <- file.path(PAIRWISE70_ROOT, "analysis/comparison_output")
