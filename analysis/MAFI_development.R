...
validate_MAFI <- function() {
  ...
  results_file <- file.path(PAIRWISE70_ROOT, "analysis/output/fragility_analysis_results.csv")
  ...
  output_file <- file.path(PAIRWISE70_ROOT, "analysis/output/MAFI_validated_results.csv")
